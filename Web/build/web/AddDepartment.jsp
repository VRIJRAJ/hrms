                    ...
                    <div class="row" style="padding-top:1%">
                        <div class="col-md-6 col-6" style="padding-top:1%;padding-bottom:0px">
                            <h5 class="h5-responsive" style="padding:0px;margin:0px">
                                <i class="fa fa-2x fa-cubes" aria-hidden="true" style="color:#4B515D"></i>&nbsp;&nbsp; Add New Employee
                            </h5>
                        </div>
                        <div class="col-md-6 col-6" style="padding-top:2%;padding-bottom:0px">
                            <img src="img/logoColor.png" width="20%" class="float-right">
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12 z-depth-1 primary-color-dark" style="padding:2%">
                            <h4 class="text-white" style="margin:0px">Add New Department</h4>
                        </div>
                        <div class="col-md-4 z-depth-1 primary-color-dark" style="padding:0px">
                            <img src="img/aaddDepart.jpg" width="100%">
                        </div>
                        <div class="col-md-8 z-depth-1">
                            <br>
                            <br>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <form method="post" action="AddDeptData.jsp">
                                                <div class="container">
                                                    <div class="row" >
                                                        <div class="col-md-12" style="padding:.6%">
                                                            <input type="text" placeholder="Department Name" name="e_dept" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row" >
                                                        <div class="col-md-4" style="padding:0.5%">
                                                            <input class="btn btn-warning btn-sm" type="submit" role="button" style="margin:0px">
