                    ...
                    <div class="row" style="padding-top:1%" >
                        ...
                        <div class="col-md-6 col-6" style="padding-top:1%;padding-bottom:0px">
                            <h5 class="h5-responsive" style="padding:0px;margin:0px">
                                <i class="fa fa-2x fa-industry" aria-hidden="true" style="color:#4B515D"></i> &nbsp;&nbsp;Manage Employees Position
                            </h5>
                        </div>
                                ...
                                <tbody>
                                     ...
                                     <%
                                        ...
                                        try{  
                                                ...
                                                ResultSet r=s.executeQuery("select * from position ORDER BY `POS_ID` DESC");  
                                                int i=1;
                                                while(r.next()){ 
                                                    //count = r.getInt(1);
                                                    out.println("<tr>");
                                                        ...
                                                        out.println("<td>");
                                                            out.println("<a class='teal-text' data-toggle='modal' data-target='#basicExample"+r.getInt(1)+"' href='"+r.getInt(1)+"'><i style='font-size:150%;color:#33b5e5' class='fa fa-pencil'></i></a>");
                                                            out.println("<a class='teal-text' href='DeletePos.jsp?id="+r.getInt(1)+"'>&nbsp;&nbsp;<i style='font-size:150%;color:#ff4444' class='fa fa-times'></i></a>");
                                                        out.println("</td>");
                                                        out.println("</tr>");
                                            ...
                                            out.println("        <!-- Modal --> "
                                                  ...
                                                  +"                      </button>"
                                                  +"                      <h4 class='modal-title w-100' id='myModalLabel'>&nbsp;Edit Position</h4>"
                                                  +"                  </div>"
                                                  +"                  <!--Body-->"
                                                  ...
                                                  +"                                  <br>"
                                                  +"                                <br>"
                                                  +"                                   <form method='post' action='UpdatePosition.jsp?id="+r.getInt(1)+"'>"
                                                  +"                                      <p style='font-size:80%;margin: 0px;color:#880e4f'>Position Name</p>"
                                                  +"                                      <input type='text' value='"+r.getString(2)+"' required='' name='e_pos' placeholder='Position Name'>"
                                                  +"                                  "
                                                  +"                              </div>"
                                                  +"                          </div>"
                                                  +"                      </div>"
